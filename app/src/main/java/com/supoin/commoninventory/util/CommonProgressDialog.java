...
public class CommonProgressDialog extends AlertDialog {
	...
	// public CommonProgressDialog(Context context, DialogListener listener) {
	// super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.progressbar_goods);
		// button = (Button) findViewById(R.id.progressbar_button2);
