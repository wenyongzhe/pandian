...
//下载最大盘点数量
public class DownloadMaxNumberService implements ISoapService {
	private static final String SOAP_ACTION = NameSpace
			+ "IPDAService/DownDrugCode";
	private static final String MethodName = "downloadMaxNumber";
	private JSONObject inputJson;
	private ThreadLocal<Integer> retryCounter = new ThreadLocal<Integer>();	
	private static final String APPLICATION_JSON = "application/json";
	public   DownloadMaxNumberService(JSONObject inputJson) {
