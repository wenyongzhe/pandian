...
//获取版本列表
public class JsonVersionGetInfoOfLaterService {
	...
	private static final String SOAP_ACTION ="http://Supoin.MiddlePlatform/IOutPortForAndroidServiceContract/JsonVersionGetInfoOfLater";
	private static final String MethodName = "JsonVersionGetInfoOfLater";
	private byte[] stream;
	...
	public JsonVersionGetInfoOfLaterService(String CFullISN, String CName) {
