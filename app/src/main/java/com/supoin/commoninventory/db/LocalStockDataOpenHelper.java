...
public class LocalStockDataOpenHelper extends SQLiteOpenHelper {
	private static final int VERSION = 3;
	private static LocalStockDataOpenHelper mInstance = null;

	public synchronized static LocalStockDataOpenHelper getInstance(
			Context context) {
		if (mInstance == null) {
			DatabaseContext dbContext = new DatabaseContext(context);
			mInstance = new LocalStockDataOpenHelper(dbContext);
		}
		return mInstance;
	};

	public LocalStockDataOpenHelper(Context context) {
		this(context, SQLDataSqlite.dbName, VERSION);
	}

	public LocalStockDataOpenHelper(Context context, String name,
			int version) {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("create table CheckDetail ("
				...
				+ "CheckID nvarchar(48) NOT NULL,"
				+ "PositionID nvarchar(48), "
				+ "GdBar nvarchar(64) NOT NULL," + "CheckNum float(9),"
				+ "GdArtNO nvarchar(36), " + "GdStyle nvarchar(36), "
				+ "GdColorID nvarchar(32)," + "GdSizeID nvarchar(32), "
				+ "CheckTime nvarchar(30)," + "ReservedMg nvarchar(64), "
				+ "GdName nvarchar(128)," + "GdColorName nvarchar(32), "
