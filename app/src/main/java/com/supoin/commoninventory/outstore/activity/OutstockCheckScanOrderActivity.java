...
import com.supoin.commoninventory.db.SQLOutStockDataSqlite.ScanOrderInfo;
...
import com.supoin.commoninventory.outstore.adapter.CheckScanOrderListAdapter;
...
public class OutstockCheckScanOrderActivity extends BaseActivity {
	private SharedPreferences sp;
	private String strShopID;
	private TextView tv_checkID, tv_positionID;
	private ListView mListView;
	private LinearLayout ll_scan_location;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initText();
		CustomTitleBar
				.getTitleBar(OutstockCheckScanOrderActivity.this, R.string.scan_sequence_query, false);
		sqlStockDataSqlite = new SQLOutStockDataSqlite(
				OutstockCheckScanOrderActivity.this, true);
		...
		ll_scan_location = (LinearLayout) findViewById(R.id.ll_scan_location);
		ll_scan_location.setVisibility(View.GONE);
		
		mMainSummaryInfoList = sqlStockDataSqlite.GetSummaryList(strShopID);

		if (mMainSummaryInfoList.size() < 1) {
			AlertUtil.showToast(AlertUtil.getString(R.string.outstock_no_inventory_data), OutstockCheckScanOrderActivity.this);
		...
		tv_checkID.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mMainSummaryInfoList.size() > 0) {
					...
					AlertUtil.showAlert(OutstockCheckScanOrderActivity.this, R.string.dialog_title,
							R.string.outstock_no_inventory_data, R.string.ok, new View.OnClickListener() {
								@Override
								public void onClick(View v) {
		...
		// mSpinnerAdapter1 = new SpinnerAdapter1(InstockCheckScanOrderActivity.this,
		// strCheckIdList);
		// mSpinnerAdapter2 = new SpinnerAdapter1(InstockCheckScanOrderActivity.this,
		// strPositionList);
		...
		// InstockCheckScanOrderActivity.this, strPositionList);
		// spinner_positionID.setAdapter(mSpinnerAdapter2);
		//
		// }
		//
		...
		// InstockCheckScanOrderActivity.this,
		// mScanOrderInfoList);
		// mListView.setAdapter(mCheckScanOrderListAdapter);
		// tv_amounts.setText(amount + "");
		//
		// } else {
		// AlertUtil.showToast("无盘点数据", InstockCheckScanOrderActivity.this);
		// }
		//
		// }
		//
	...
	protected void showPupopWindow() {
		View contentView = LayoutInflater.from(OutstockCheckScanOrderActivity.this)
		...
		View rootview = LayoutInflater.from(OutstockCheckScanOrderActivity.this)
...
//					}
				...
				if (mScanOrderInfoList != null && mScanOrderInfoList.size() > 0) {
					mCheckScanOrderListAdapter = new CheckScanOrderListAdapter(OutstockCheckScanOrderActivity.this, mScanOrderInfoList);
					mListView.setAdapter(mCheckScanOrderListAdapter);
					tv_amounts.setText(amount + "");
				} else {
					AlertUtil.showToast(AlertUtil.getString(R.string.outstock_no_inventory_data), OutstockCheckScanOrderActivity.this);
