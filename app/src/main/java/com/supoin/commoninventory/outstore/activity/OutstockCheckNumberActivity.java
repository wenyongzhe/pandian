...
import com.supoin.commoninventory.outstore.adapter.CheckNumberListAdapter;
...
public class OutstockCheckNumberActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initText();
		CustomTitleBar.getTitleBar(OutstockCheckNumberActivity.this, bianhao,R.string.query_title, false);
		sqlStockDataSqlite = new SQLOutStockDataSqlite(OutstockCheckNumberActivity.this,true);
		...
		if (mMainSummaryInfoList.size() < 1) {
			AlertUtil.showToast(R.string.outstock_no_inventory_data, OutstockCheckNumberActivity.this);
		...
		tv_checkID.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(mMainSummaryInfoList.size()>0){
					...
					AlertUtil.showAlert(OutstockCheckNumberActivity.this, R.string.dialog_title,
	...
	protected void showPupopWindow() {
		View contentView = LayoutInflater.from(OutstockCheckNumberActivity.this)
				...
				if (isCheck) {
					...
					if (mCheckNODetailList != null
						...
						mCheckNumberListAdapter = new CheckNumberListAdapter(
								OutstockCheckNumberActivity.this, mCheckNODetailList);
						...
						tv_amount.setText("");
						AlertUtil.showToast(R.string.no_pertinent_data, OutstockCheckNumberActivity.this);
					}
				} else {
					// 不选中明细
					...
					mCheckNumberListAdapter1 = new CheckNumberListAdapter1(OutstockCheckNumberActivity.this, mMainSummaryInfoList1);
		...
		View rootview = LayoutInflater.from(OutstockCheckNumberActivity.this).inflate(R.layout.activity_main, null);
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 0) {
				...
				if (mMainSummaryInfoList != null
					...
					AlertUtil.showToast(R.string.no_inventory_detailed_data, OutstockCheckNumberActivity.this);
					mCheckNODetailList = new ArrayList<SQLOutStockDataSqlite.StaCheckNODetail>();
					mCheckNumberListAdapter = new CheckNumberListAdapter(
							OutstockCheckNumberActivity.this, mCheckNODetailList);
					mListView.setAdapter(mCheckNumberListAdapter);
					return;
				...
				mCheckNumberListAdapter1 = new CheckNumberListAdapter1(
						OutstockCheckNumberActivity.this, mMainSummaryInfoList1);
				mListView1.setAdapter(mCheckNumberListAdapter1);
				mCheckNumberListAdapter1.notifyDataSetChanged();
