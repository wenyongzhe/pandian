...
import com.supoin.commoninventory.adapter.CheckNumberListAdapter;
...
import com.supoin.commoninventory.db.SQLStockDataSqlite.StaCheckNODetail;
...
public class CheckNumberActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initText();
		CustomTitleBar.getTitleBar(CheckNumberActivity.this, bianhao,R.string.query_title, false);
		sqlStockDataSqlite = new SQLStockDataSqlite(CheckNumberActivity.this,true);
		...
		if (mMainSummaryInfoList.size() < 1) {
			AlertUtil.showToast(R.string.no_inventory_data, CheckNumberActivity.this);
		...
		tv_checkID.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(mMainSummaryInfoList.size()>0){
					...
					AlertUtil.showAlert(CheckNumberActivity.this, R.string.dialog_title,
	...
	protected void showPupopWindow() {
		View contentView = LayoutInflater.from(CheckNumberActivity.this)
				...
				if (isCheck) {
					...
					if (mCheckNODetailList != null
						...
						mCheckNumberListAdapter = new CheckNumberListAdapter(
								CheckNumberActivity.this, mCheckNODetailList);
						...
						tv_amount.setText("");
						AlertUtil.showToast(R.string.no_pertinent_data, CheckNumberActivity.this);
					}
				} else {
					// 不选中明细
					...
					mCheckNumberListAdapter1 = new CheckNumberListAdapter1(CheckNumberActivity.this, mMainSummaryInfoList1);
		...
		View rootview = LayoutInflater.from(CheckNumberActivity.this).inflate(R.layout.activity_main, null);
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 0) {
				...
				if (mMainSummaryInfoList != null
					...
					AlertUtil.showToast(R.string.no_inventory_detailed_data, CheckNumberActivity.this);
					mCheckNODetailList = new ArrayList<SQLStockDataSqlite.StaCheckNODetail>();
					mCheckNumberListAdapter = new CheckNumberListAdapter(
							CheckNumberActivity.this, mCheckNODetailList);
					mListView.setAdapter(mCheckNumberListAdapter);
					return;
				...
				mCheckNumberListAdapter1 = new CheckNumberListAdapter1(
						CheckNumberActivity.this, mMainSummaryInfoList1);
				mListView1.setAdapter(mCheckNumberListAdapter1);
				mCheckNumberListAdapter1.notifyDataSetChanged();
