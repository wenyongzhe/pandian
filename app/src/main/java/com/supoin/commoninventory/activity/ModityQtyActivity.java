...
public class ModityQtyActivity extends Activity implements OnClickListener {
...
//	public  TextView name;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomTitleBar.getTitleBar(ModityQtyActivity.this,AlertUtil.getString(R.string.enter_quantity), false);
	}else {
		CustomTitleBar.getTitleBar(ModityQtyActivity.this, AlertUtil.getString(R.string.modify_quantity), false);
	}
		...
		sqlStockDataSqlite = new SQLStockDataSqlite(ModityQtyActivity.this,true);
...
//		});
	...
	private void keyDownOk() {
		String strQty = et_qty.getText().toString().trim();
		if (strQty.length() < 1) {
			AlertUtil.showAlert(ModityQtyActivity.this,R.string.warning, R.string.quantity_not_null,
...
//				}
			...
			AlertUtil.showAlert(ModityQtyActivity.this, R.string.dialog_title, R.string.quantity_error,
					R.string.ok, new View.OnClickListener() {
	...
	private void popupInputMethodWindow() {
		handler.postDelayed(new Runnable() {
			@Override
			public void run() {
				InputMethodManager imm = (InputMethodManager) getSystemService(ModityQtyActivity.INPUT_METHOD_SERVICE);
				// 显示软键盘
	...
	public void onClick(View v) {
		...
		case R.id.btn_cancl:
			GoodsDetailsActivity.is_intercept = true;
			InputMethodManager inputMethodManager = (InputMethodManager) getSystemService(ModityQtyActivity.INPUT_METHOD_SERVICE);
			inputMethodManager.hideSoftInputFromWindow(ModityQtyActivity.this
