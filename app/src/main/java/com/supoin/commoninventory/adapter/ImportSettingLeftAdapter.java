...
public class ImportSettingLeftAdapter extends BaseAdapter {
	...
	public ImportSettingLeftAdapter(List<String> list, Context context) {
...
//			e1e1e1  225,225,225
	...
	public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
		ImportSettingLeftAdapter.isSelected = isSelected;
	}
