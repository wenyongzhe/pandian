...
public class ScanGoodsListAdapter extends BaseAdapter {
	// 商品扫描盘点列表
	...
	public ScanGoodsListAdapter(Context context, List<MainSummaryInfo> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = mInflater.inflate(
					R.layout.item_listview_scan_goods, null);
