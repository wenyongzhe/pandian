...
import com.supoin.commoninventory.instore.adapter.CheckScanOrderListAdapter;
...
/**
 * 扫描顺序
 * @date 2017-5-24 下午1:34:30 
 */
public class InstockCheckScanOrderActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initText();
		CustomTitleBar
				.getTitleBar(InstockCheckScanOrderActivity.this, R.string.scan_sequence_query, false);
		sqlStockDataSqlite = new SQLInStockDataSqlite(
				InstockCheckScanOrderActivity.this, true);
		...
		if (mMainSummaryInfoList.size() < 1) {
			AlertUtil.showToast(AlertUtil.getString(R.string.instock_no_inventory_data), InstockCheckScanOrderActivity.this);
		...
		tv_checkID.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mMainSummaryInfoList.size() > 0) {
					...
					AlertUtil.showAlert(InstockCheckScanOrderActivity.this, R.string.dialog_title,
	...
	protected void showPupopWindow() {
		View contentView = LayoutInflater.from(InstockCheckScanOrderActivity.this)
		...
		View rootview = LayoutInflater.from(InstockCheckScanOrderActivity.this)
...
//					}
				...
				if (mScanOrderInfoList != null && mScanOrderInfoList.size() > 0) {
					mCheckScanOrderListAdapter = new CheckScanOrderListAdapter(InstockCheckScanOrderActivity.this, mScanOrderInfoList);
					mListView.setAdapter(mCheckScanOrderListAdapter);
					tv_amounts.setText(amount + "");
				} else {
					AlertUtil.showToast(AlertUtil.getString(R.string.instock_no_inventory_data), InstockCheckScanOrderActivity.this);
