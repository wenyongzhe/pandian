 ...
 * 入库查询
 */
public class InstockCheckActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomTitleBar.getTitleBar(InstockCheckActivity.this, R.string.query_instock, false);
	...
	private void initText() {
		...
		tv_bianhao_cxtx.setText(importStrArrayList.get(1)+InstockCheckActivity.this.getResources().getString(R.string.query_title));
	}
	@Override
	...
	public void onClick(View v) {
		...
		case R.id.ll_check_number:
			Intent intent1 = new Intent(InstockCheckActivity.this,InstockCheckNumberActivity.class);
			startActivity(intent1);
			break;
		case R.id.ll_scan_order:
			Intent intent2 = new Intent(InstockCheckActivity.this,InstockCheckScanOrderActivity.class);
