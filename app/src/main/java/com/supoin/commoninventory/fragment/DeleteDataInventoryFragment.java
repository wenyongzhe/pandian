...
public class DeleteDataInventoryFragment extends Fragment implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sqlStockDataSqlite = new SQLStockDataSqlite(getActivity(),
				true);
		strDeleteType = sp.getString(ConfigEntity.DeleteDataWayKey,
				ConfigEntity.DeleteDataWay);
