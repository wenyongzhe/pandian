...
public class DeleteDataInstockFragment extends Fragment implements OnClickListener {
...
//		}
	...
	private void setData() {
		...
		if (checkMainList != null && checkMainList.size() > 0) {
			...
			empty_list_view1.setText(AlertUtil.getString(R.string.instock_no_inventory_data));
